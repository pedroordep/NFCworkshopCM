...
public class PlayGame extends AppCompatActivity {
    ...
    private void readTextFromMessage(NdefMessage ndefMessage) {
        ...
        if(ndefRecords.length == 5) {
            questionText.setText(getTextFromNdefRecord(ndefRecords[0]));

            answers.add(getTextFromNdefRecord(ndefRecords[1]));
            correctAnswer = getTextFromNdefRecord(ndefRecords[1]);

            answers.add(getTextFromNdefRecord(ndefRecords[2]));
            answers.add(getTextFromNdefRecord(ndefRecords[3]));
            answers.add(getTextFromNdefRecord(ndefRecords[4]));

            Collections.shuffle(answers, new Random(seed));

            bA1.setText(answers.get(0));
            bA2.setText(answers.get(1));
            bA3.setText(answers.get(2));
            bA4.setText(answers.get(3));
        }
        else {
